...
function Cadastro() {
  ...
  const validatePassword = (senha, nome, email) => {
    ...
    if (
      nome &&
      senha.toLowerCase().includes(nome.replace(/\s+/g, "").toLowerCase())
    )
      return "Senha não pode ser igual ao nome";
  ...
  const validateTelefone = (telefone) => {
    ...
    if (digits.length < 10 || digits.length > 11)
      return "Telefone inválido (10 ou 11 dígitos esperados)";
    return null;
  };
  ...
  const validarEtapa1 = () => {
    ...
    if ("categoria" in formData && !formData.categoria)
      newErrors.categoria = "Selecione uma categoria";
    const emailErr = validateEmail(formData.email);
    if (emailErr) newErrors.email = emailErr;
    const senhaErr = validatePassword(
      formData.senha,
  ...
  const validarEtapa2 = () => {
    ...
    if (!formData.canalComunicacao)
      newErrors.canalComunicacao = "Selecione o canal de comunicação";
  ...
  // Aqui vamos pegar a mensagem do backend, se existir
    const mensagemErro =
      err.response?.data?.message || // se o backend enviar JSON { message: "..." }
      err.response?.data || // se o backend enviar só texto
      err.message || // mensagem do Axios
    ...
    <FaArrowLeft />
        ...
        <div className="form-container">
          ...
          {currentStep === 1 && (
            <form
              ...
              className="cadastro-form form-step step-1"
            >
              <div className="form-group">
                ...
                />
                {errors.nomeCompleto && (
                  <span className="error-text">{errors.nomeCompleto}</span>
                )}
              </div>
              ...
              <div className="form-row">
                ...
                <div className="form-group full-width">
                  ...
                  {errors.nacionalidade && (
                    <span className="error-text">{errors.nacionalidade}</span>
                  )}
                </div>
              </div>
          ...
          {currentStep === 2 && (
            <form
              ...
              className="cadastro-form form-step step-2"
            >
              <div className="form-group">
                ...
                {errors.etnia && (
                  <span className="error-text">{errors.etnia}</span>
                )}
              </div>
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleInputChange("canalComunicacao", e.target.value)
                  }
                  required
                >
                  <option value="">Selecione</option>
                ...
                {errors.canalComunicacao && (
                  <span className="error-text">{errors.canalComunicacao}</span>
                )}
              </div>
      ...
      <div className="cadastro-image-section">
        <div className="image-container">
          <img
            src="\src\assets\images\cadastro_img.png"
